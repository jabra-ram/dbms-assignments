...
select distinct salary as "TOP5salaries" from employees order by salary desc limit 5;
...
select first_name, last_name from employees where first_name like 'A%' or last_name like '_TH%' or last_name like '__TH%';